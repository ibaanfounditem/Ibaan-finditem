...
<html lang="en">
    <head>
        ...
        <title>Lost-Item Finder | Verified</title>
        ...
        <main>
            ...
            <div class="output-container">
                <?php
                    ...
                    $result=$conn->query("SELECT * FROM tb_verifiedmsg INNER JOIN tb_residentsacc ON tb_verifiedmsg.archaccountId = tb_residentsacc.accountId ORDER BY archid DESC") or die("Error");
