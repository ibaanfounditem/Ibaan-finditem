...
<html lang="en">
    <head>
        ...
        <title>Lost-Item Finder | Help</title>
    ...
    <body>
        ...
        <nav class="navigation" id="navigation">
                ...
                <div class="nav-links">
                    ...
                    <a href="viewer_help.php" class="nav-link  active"><img src="./images/help-icon.png" width="18" height="18" style="margin-right: 3px;">Help</a>
        ...
        <main>
            <section class="forms-input" id="form-output">
                <div class="output-container">
                    <div class='output-cont-table' id='message_us'>
                    ...
                    <div class='output-cont-table' id='contact_us'>
                        <table style="width:100%">
